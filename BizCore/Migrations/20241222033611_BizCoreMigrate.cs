...
{
    /// <inheritdoc />
    public partial class BizCoreMigrate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRevenue = table.Column<double>(type: "numeric(15,2)", nullable: false),
                    TotalExpenses = table.Column<double>(type: "numeric(15,2)", nullable: false),
                    NetProfit = table.Column<double>(type: "numeric(15,2)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreateBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    UpdateBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BenefitsAmount = table.Column<decimal>(type: "numeric(15,2)", nullable: false),
                    BonusAmount = table.Column<decimal>(type: "numeric(15,2)", nullable: false),
                    PaymentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<bool>(type: "boolean", nullable: false),
                    SalaryAmount = table.Column<decimal>(type: "numeric(15,2)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreateBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    UpdateBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollAndBenefits", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_PayrollAndBenefits_Employees_EmployeeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MachineAndMaintenance", x => x.MaintenanceId);
                    table.ForeignKey(
                        name: "FK_MachineAndMaintenance_Machines_MachineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Productions", x => x.ProductionOrderId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierId = table.Column<int>(type: "integer", nullable: false),
                    WarehouseLocation = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    CreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreateBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    UpdateBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MachineAndMaintenance_MachineId",
                table: "MachineAndMaintenance",
                column: "MachineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollAndBenefits_EmployeeID",
                table: "PayrollAndBenefits",
                column: "EmployeeID");
